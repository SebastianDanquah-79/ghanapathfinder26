-- Security hardening applied to the existing analytics view and feed RPCs.
-- Keep the public analytics RPCs unchanged because the homepage currently uses them.
-- Feed mutation/notification RPCs are not callable by anonymous clients.
