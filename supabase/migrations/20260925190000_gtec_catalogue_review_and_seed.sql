...
('MEST Africa',null,'Technology and entrepreneurship','hybrid',null,'Varies','MEST Africa','https://meltwater.org/','{https://meltwater.org/}','official website','Provider exists; individual course details require current review.',true),
