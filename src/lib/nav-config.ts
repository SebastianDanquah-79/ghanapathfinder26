import {
  Home, Building2, BookOpen, Award, Briefcase, Users, Target, Search, Sparkles,
  CalendarDays, Bookmark, LayoutDashboard, SlidersHorizontal, Lightbulb, Shield,
  Info, Globe, MessageCircle, GraduationCap,
} from "@/lib/icons";

export interface NavItem { label: string; href: string; desc?: string; }
export interface NavSection { id: string; label: string; icon: typeof Home; href: string; items: NavItem[]; }

export const navSections: NavSection[] = [
  { id:"study", label:"Study", icon:Building2, href:"/search?kind=university", items:[
    ...
    {label:"International universities",href:"/international-universities",desc:"Explore beyond Ghana"},
  ...
  { id:"fund", label:"Funding", icon:Award, href:"/scholarships", items:[
    {label:"Scholarships",href:"/scholarships",desc:"Find funding for your future"},
    {label:"Scholarship matcher",href:"/matcher",desc:"Find your matches"},
    {label:"Compare scholarships",href:"/compare-scholarships",desc:"Compare opportunities"},
  ]},
  { id:"career", label:"Careers", icon:Briefcase, href:"/careers", items:[
    {label:"Careers",href:"/careers",desc:"See where your path leads"},
    {label:"Jobs & opportunities",href:"/opportunities",desc:"Find verified opportunities"},
  ...
  { id:"community", label:"Community", icon:Users, href:"/community", items:[
    {label:"Community feed",href:"/community",desc:"Learn from people like you"},
    {label:"International students",href:"/international-students",desc:"Connect with opted-in students"},
    {label:"Leaders of Africa",href:"/leaders",desc:"Explore verified leadership records"},
    {label:"Innovation feed",href:"/feed",desc:"Watch African innovation"},
    {label:"News",href:"/news",desc:"Follow Africa-focused news"},
  ...
  { id:"plan", label:"Plan", icon:Target, href:"/my-path", items:[
    ...
    {label:"Collections",href:"/saved?tab=collections",desc:"Organise what you discover"},
...
export const accountItems: NavItem[] = [
  ...
  {label:"Collections",href:"/saved?tab=collections"},
...
export const navIcons = { Home, BookOpen, Search, Sparkles, CalendarDays, Bookmark, LayoutDashboard, SlidersHorizontal, Lightbulb, Shield, Info, Globe, MessageCircle, GraduationCap };
