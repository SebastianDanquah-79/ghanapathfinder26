...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for GhanaPathFinder, a college, scholarship and career companion for Ghanaian students. Read the signed-in student's profile, saved universities and scholarships, tracked scholarship applications, deadlines and checklist, and add or update applications in their tracker.",
