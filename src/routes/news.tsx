...
function News() {
  ...
  return <div className="min-h-dvh bg-background"><Navbar/><main className="px-4 pb-14 pt-20 sm:px-8"><div className="mx-auto max-w-7xl">
    ...
    {!query.isLoading&&!articles.length&&<div className="mt-8 rounded-xl border border-dashed border-border p-10 text-center text-sm text-muted-foreground">No verified news is currently available for this filter.</div>}
