        ...
        <div className="max-w-7xl mx-auto">
          <header className="mb-4">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Every programme recorded in GhanaPath — search by subject, institution, region or
          ...
          {/* Popular searches */}
          <div className="flex gap-2 hscroll hscroll-bleed pb-2">
          ...
          {/* Category chips */}
          <div className="flex gap-2 hscroll hscroll-bleed pb-2 mt-1">
