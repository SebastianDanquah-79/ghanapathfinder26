...
export const mockCareerData: Record<string, CareerData> = {
  "Computer Science": {
...
export const careerSlug = (major: string) =>
  major
    .toLowerCase()
    .replace(/&/g, "and")
    .replace(/[^a-z0-9]+/g, "-")
...
export const careerBySlug = (slug: string) =>
  Object.values(mockCareerData).find((c) => careerSlug(c.major) === slug);
