...
const ClassificationCenterRoute = ClassificationCenterRouteImport.update({ id: '/classification-center', path: '/classification-center', getParentRoute: () => rootRouteImport, } as any)
const EmployeeRoute = EmployeeRouteImport.update({ id: '/employee', path: '/employee', getParentRoute: () => rootRouteImport, } as any)
...
const StudentAssessmentRoute = StudentAssessmentRouteImport.update({ id: '/student-assessment', path: '/student-assessment', getParentRoute: () => rootRouteImport, } as any)
