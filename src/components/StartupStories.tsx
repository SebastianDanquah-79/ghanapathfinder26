...
const stories: FounderStory[] = [
  ...
  },
  {
    ...
    year: "2020",
    role: "Co-founders",
    tag: "Mobility FinTech",
    story: "Built vehicle financing around the everyday economics of African mobility entrepreneurs, then expanded the model beyond its Nigerian roots.",
    source: "https://www.moove.io/drive-to-own/about-moove",
    sourceLabel: "moove.io",
    founderPhotos: ["https://cdn.businessday.ng/wp-content/uploads/2025/01/Ladi-Delano-and-Jide-Odunsi-1.png"],
    logo: logo("moove.io"),
  },
  {
    founders: "Coenraad J. Jonker & Tjaart van der Walt",
    company: "Tyme",
    place: "South Africa / Pan-African",
    year: "2012",
    role: "Co-founders",
    tag: "Digital Banking",
    story: "Started with a mobile money and banking-access problem and developed a digital banking model that later scaled across emerging markets.",
    source: "https://www.gotyme.com/who-we-are",
    sourceLabel: "gotyme.com",
    founderPhotos: ["https://cassette.sphdigital.com.sg/image/businesstimes/cb349d5f286e4a3f2b79ac89306b65443c83ce72449223415ee1215710eaadd8?dpr=1&f=webp&h=1046&w=1570"],
    logo: logo("gotyme.com"),
  },
  {
    ...
    role: "Co-founders",
    tag: "FinTech",
    story: "Built a broad financial platform around underserved customers, combining lending, payments and digital financial services at scale.",
    source: "https://halan.com/about/",
    sourceLabel: "halan.com",
    founderPhotos: ["https://mms.businesswire.com/media/20230131005989/en/1701515/4/Mounir-and-Ahmad.jpg"],
    logo: logo("mnt-halan.com"),
  },
  {
    ...
    role: "Co-founders",
    tag: "FinTech",
    story: "Built payment infrastructure and business banking tools around the daily needs of African businesses, especially SMEs.",
    source: "https://moniepoint.com/blog/moniepoint-announces-successful-completion-of-usdollar200-million-series-c-round-to-power-financial-inclusion",
    sourceLabel: "moniepoint.com",
    founderPhotos: ["https://mms.businesswire.com/media/20241028604772/en/2286045/5/tosin-and-felix.jpg?download=1"],
    logo: logo("moniepoint.com"),
  },
  {
    ...
    story: "Built foundational electronic payment infrastructure in Nigeria and grew it into one of Africa's best-known digital commerce companies.",
    source: "https://interswitchgroup.com/leadership/",
    sourceLabel: "interswitchgroup.com",
    founderPhotos: ["https://interswitchgroup.com/assets/images/leadership/mitch-final.png"],
    logo: logo("interswitchgroup.com"),
  },
  {
    founders: "Thomas Buberl",
    company: "AXA",
    place: "Global / Africa",
    year: "2016",
    role: "Group CEO",
    tag: "Insurance & AI",
    story: "Leads a global insurance group through a period of digital transformation, risk innovation and technology investment across major markets.",
    source: "https://www.axa.com/en/about-us/executive-management",
    sourceLabel: "axa.com",
    founderPhotos: ["https://www.bsg.ox.ac.uk/sites/default/files/styles/square_image/public/2025-09/t_buberl_picture.png?h=23eccd95&itok=DXhYTERU"],
    logo: logo("axa.com"),
  },
];
