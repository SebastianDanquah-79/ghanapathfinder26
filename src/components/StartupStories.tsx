...
const stories: FounderStory[] = [
  ...
  { founders: "Bright Simons", company: "mPedigree", place: "Ghana", year: "2007", role: "Founder & CEO", tag: "HealthTech", story: "Built verification technology around the problem of counterfeit medicine and traceability.", source: "https://mpedigree.com/", founderPhotos: ["https://commons.wikimedia.org/wiki/Special:Redirect/file/Bright%20Simons%20-%20TED%20Fellows%20Talk.jpg"], logo: logo("mpedigree.com") },
  { founders: "Ham Serunjogi & Maijid Moujaled", company: "Chipper Cash", place: "Uganda / Pan-African", year: "2018", role: "Co-founders", tag: "FinTech", story: "Built a financial platform around the friction of moving money across African borders.", source: "https://www.chippercash.com/leadership-team-member/ham-serunjogi", founderPhotos: ["https://i0.wp.com/kikubolane.com/wp-content/uploads/2021/10/Serunjogi-and-Moujaled-Chipper-Cash-Founder-1536x1536-1.jpg?resize=780%2C780&ssl=1"], logo: logo("chippercash.com") },
  { founders: "Drew Durbin & Lincoln Quirk", company: "Wave", place: "Senegal / Pan-African", year: "2018", role: "Co-founders", tag: "FinTech", story: "Turned cross-border transfer lessons into a lower-cost domestic payments network.", source: "https://www.wave.com/en/about/", founderPhotos: ["https://www.wave.com/img/exec-team/drew-headshot_hu26e580986edb815a810b42dc2193d8ab_653879_400x400_resize_q75_box.b26520ddeabfae69be32b04f93792e0e74838aa20d1b6d6fd1b5828df4e801e6.jpg"], logo: logo("wave.com") },
  ...
  { founders: "Jesse Ghansah & Barima Effah", company: "Float", place: "Ghana / Africa", year: "2019", role: "Co-founders", tag: "FinTech", story: "Built financial software around cash flow, payments and working capital for SMEs.", source: "https://www.float.africa/", founderPhotos: ["https://eu-images.contentstack.com/v3/assets/blta47798dd33129a0c/blt6121c8495ae822fc/66d22738eaf374419b7ce483/776861-4791.jpg?auto=webp&disable=upscale&format=jpg&quality=80&width=1280"], logo: logo("float.africa") },
  { founders: "Isaac Sesi", company: "Sesi Technologies", place: "Ghana / Africa", year: "2018", role: "Founder & CEO", tag: "AgriTech Hardware", story: "Turned engineering research into practical agricultural technology.", source: "https://sesitechnologies.com/about-us/", founderPhotos: ["https://africaprize.raeng.org.uk/media/x3mbtecp/2020-isaac-sesi-ghana-headshot-portrait.jpeg"], logo: logo("sesitechnologies.com") },
  { founders: "Olugbenga Agboola", company: "Flutterwave", place: "Nigeria / Pan-African", year: "2016", role: "Founder & CEO", tag: "FinTech", story: "Built payment infrastructure for businesses operating across fragmented African markets.", source: "https://flutterwave.com/us/press-kit?section=people", founderPhotos: ["https://rave-services.myflutterwave.com/v1/services/filestack/download/FD6tGKsTK60zI2Hht8uw?resize=1&width=600"], logo: logo("flutterwave.com") },
  { founders: "Fred Swaniker", company: "ALX", place: "Ghana / Pan-African", year: "2017", role: "Founder & CEO", tag: "Talent & Education", story: "Built a continent-wide talent ecosystem around practical digital skills and leadership.", source: "https://www.alxafrica.com/leadership/", founderPhotos: ["https://www.mckinsey.com/~/media/mckinsey/featured%20insights/middle%20east%20and%20africa/leadership%20lessons%20from%20africas%20trailblazers/fred-swaniker-headshot-868.jpg?cpy=Center&cq=50&mw=767"], logo: logo("alxafrica.com") },
  { founders: "Sam Moorhouse & Riyanat", company: "Turntabl", place: "Ghana / UK", year: "2019", role: "Co-founders", tag: "Software Engineering", story: "Started by training software engineers in Ghana and grew into a global engineering company.", source: "https://turntabl.io/company", founderPhotos: ["https://pbs.twimg.com/media/G0aBPQuXkAA-Otn.jpg"], logo: logo("turntabl.io") },
  { founders: "Zhou Yahui & Opera team", company: "OPay", place: "Nigeria / Africa", year: "2018", role: "Founder / Opera-backed team", tag: "FinTech", story: "Built a large-scale mobile payments platform around everyday financial services.", source: "https://techcrunch.com/2019/07/09/opera-founded-starup-opay-raises-50m-for-mobile-finance-in-nigeria/", founderPhotos: ["https://p6.itc.cn/images01/20210115/9dee5f36450e44f7b3aafb89cbdcb367.jpeg"], logo: logo("opayweb.com") },
  { founders: "Patricia Obo-Nai", company: "Telecel Ghana", place: "Ghana", year: "2024", role: "Chief Executive Officer", tag: "Telecom", story: "Leads Telecel Ghana as it expands connectivity, digital services and financial inclusion.", source: "https://telecel.com.gh/explore-telecel/executive-team/", founderPhotos: ["https://telecel.com.gh/img/execs/squared/patricia.png"], logo: logoFor("telecel.com.gh") },
  { founders: "Mitchell Elegbe", company: "Interswitch", place: "Nigeria / Africa", year: "2002", role: "Founder & Group Managing Director / CEO", tag: "FinTech", story: "Founded Interswitch to solve payment infrastructure problems in Nigeria and grew it into a major African payments company.", source: "https://interswitchgroup.com/company/leadership/mitchell-elegbe/", founderPhotos: ["https://iswwebsitestg.blob.core.windows.net/switchwebsite/interswitchgroup.com/executives/website-images/Mitchell%20Elegbe.webp"], logo: logoFor("interswitchgroup.com") },
...
const StartupStories = () => (
  <section id="founders" className="py-12 lg:py-24 px-4">
    ...
    <div className="max-w-7xl mx-auto">
      <SectionHeader badge="African founders" title="Meet the people building" highlight="Africa's future" description="Real companies, real founders and practical lessons from startups and African technology builders, with a strong focus on Ghana." />
      <div className="flex items-center gap-2 text-xs text-muted-foreground mb-5"><Flame className="h-3.5 w-3.5 text-primary" /><span>Stories are selected for what students can learn from the journey.</span></div>
      <div className="flex hscroll hscroll-bleed snap-x snap-mandatory scroll-smooth gap-4 overflow-x-auto pb-3 md:grid md:grid-cols-2 lg:grid-cols-5 md:overflow-visible md:mx-0 md:px-0 md:pb-0">
        {stories.map((s, i) => (
          <motion.article key={s.company} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: (i % 5) * 0.05, duration: 0.3 }} className="min-w-[16.5rem] md:min-w-0 bg-background border border-border rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow snap-start">
            ...
            <div className={`${s.founderPhotos.length > 1 ? "grid grid-cols-2" : ""} aspect-square bg-muted overflow-hidden`}>{s.founderPhotos.slice(0, 2).map((photo, index) => <div key={`${photo}-${index}`} className="relative min-h-0 overflow-hidden"><SafeImage src={photo} {...(s.fallbackPhoto ? { fallback: s.fallbackPhoto } : {})} alt={s.photoLabels?.[index] ?? `${s.founders}, ${s.company}`} />{s.photoLabels?.[index] && <span className="absolute left-2 bottom-2 max-w-[calc(100%-1rem)] rounded-md bg-black/55 px-2 py-1 text-[9px] font-medium text-white">{s.photoLabels[index]}</span>}</div>)}</div>
