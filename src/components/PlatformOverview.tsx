  ...
  return <section className="border-y border-border bg-secondary/10 py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 space-y-8">
      ...
      <div className="grid lg:grid-cols-[1.4fr_.6fr] gap-6">
        <div><div className="flex items-center justify-between mb-3"><h3 className="font-semibold flex items-center gap-2"><GraduationCap className="h-4 w-4"/>University intelligence</h3><a href="/search?kind=university" className="text-xs font-medium text-primary">View directory</a></div>
